...
?>
    <div class="movie_container" id=<?php echo
    ...
    <h4 class="movie__genre"><?php echo
        $movie->genres; ?></h4>
    <h4 class="movie_duration">Продолжительность
    фильма: <?php echo $movie->duration; ?></h4>

    <?php if(isset($_COOKIE['watched']) &&
    array_key_exists($movie->id,
    $_COOKIE['watched']) ): ?>
     <button class="movie__watched
     movie__watched_active">(Смотрел)</button>
    <?php else: ?>
